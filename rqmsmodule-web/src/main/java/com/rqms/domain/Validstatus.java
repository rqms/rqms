...
public class Validstatus implements java.io.Serializable {
	...
	@Column(name = "statustype", nullable = false, length = 100)
	...
	@Column(name = "statusdescription", nullable = false, length = 1000)
	...
	@Column(name = "stampdate", nullable = false, length = 50)
